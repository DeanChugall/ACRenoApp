...
public class FakturaController implements Initializable, java.io.Serializable {
    ...
    private void btnDodajArtiklRacunMouseClick(MouseEvent mouseEvent) {
        ...
        if (GeneralUiUtility.proveriStringDaLiImaSlova(txtFcenaArtikla.getText()) ||
                GeneralUiUtility.proveriStringDaLiImaSlova(txtFnabavnaCenaArtikla.getText())) {
            GeneralUiUtility.alertDialogBox(Alert.AlertType.ERROR,
