...
public class PrintRacuniControler implements Initializable, Serializable {
    ...
    private void initRacunFields() throws BackingStoreException {
        ...
        Constants constants = new Constants(); //Ako nije napravljen mora da se restartuje App
        lblAdresaFirmeNaRacunu.setText(constants.PRINT_FAKTURA_ADRESA_FIRME);
        lblGradFirmeNaRacunu.setText(constants.PRINT_FAKTURA_GRAD_FIRME);
        lblTelefonFirme.setText(constants.PRINT_FAKTURA_TELEFON_FIRME);
        lblSajtFirmeNaRacunu.setText(constants.PRINT_FAKTURA_SAJT_FIRME);
        lblEmailFirmeNaRacunu.setText(constants.PRINT_FAKTURA_EMAIL_FIRME);
        txtFziroRacunFirmeNaRacunu.setText(constants.PRINT_FAKTURA_ZIRORACUN_FIRME);
